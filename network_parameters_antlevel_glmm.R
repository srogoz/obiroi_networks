...
library(lme4)
#read as df
colony_activity_singleant<-read.csv(file = "network_parameters/antlevel_1_truncated_2min/ANTLEVEL_strength_mean06112025.csv")
colony_activity_singleant<-read.csv(file = "network_parameters/antlevel_1_truncated_2min/ANTLEVEL_burstiness06112025.csv")
colony_activity_singleant<-read.csv(file = "network_parameters/antlevel_1_truncated_2min/ANTLEVEL_waitingtime_mean06112025.csv")
colony_activity_singleant<-read.csv(file = "network_parameters/antlevel_1_truncated_2min/ANTLEVEL_local_efficiency06112025.csv")
colony_activity_singleant<-read.csv(file = "network_parameters/antlevel_1_truncated_2min/ANTLEVEL_interactionlength_mean06112025.csv")
colony_activity_singleant$ant<-present_ants
...
param_plot <- ggplot(df_glmm, aes(x = colony, y = rsdm, fill = treatment)) +
  ...
  labs(
    title = " ",
    x = "colony",
    y = "mean interactionlength [frames] "
  ) +
