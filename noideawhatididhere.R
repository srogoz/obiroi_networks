...
source("global_parameters_exp1_inf.R")# pick right colony
...
for (i in 1:length(selected_colonies)){
  ...
  saveRDS( prevalence_long, paste0("simulations/",colony_name,"_prevalencesim_2s.rds"))
  ...
  ggsave(filename = paste0("simulations/prevalence_2s_" , 
...
prevalence_list<-get_colony_files("simulations/exp1_12hs/data/2s_interaction/", selected_colonies)
